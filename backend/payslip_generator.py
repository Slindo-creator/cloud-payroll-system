...
def generate_employee_payslip(employee_name, email, role, gross, tax, net):
    ...
    emp_table = Table(emp_data, colWidths=[110, 160, 90, 170])
    ...
    financial_data = [
        ...
        [Paragraph("Statutory Income Tax Withholding (20%)", body_style), Paragraph(f"- R {tax:.2f}", colors.HexColor("#C53030"))], # Red text for deductions
...
if __name__ == "__main__":
    # Test runner to verify layout compilation manually
